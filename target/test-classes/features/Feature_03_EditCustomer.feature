...
Scenario: Edit customer with empty customer id 
	...
	Then Verify successfully with message Edit Page "Customer ID is required" 
...
Scenario Outline: Edit customer with input numeric value name field 
	...
	Then Verify successfully with message Edit Page "<Message>" 
	...
	Examples: 
		...
		Scenario: Edit customer with input special value customer ID field 
			...
			Then Verify successfully with message Edit Page "Address Field must not be blank" 
		...
		Scenario: Edit customer with input special value customer ID field 
			...
			Then Verify successfully with message Edit Page "City Field must not be blank" 
		...
		Scenario Outline: Edit customer with input numeric value name field 
			...
			Examples: 
				...
				Scenario: Edit customer with input special value customer ID field 
					...
					Then Verify successfully with message Edit Page "State must not be blank" 
						...
						Scenario Outline: Edit customer with input numeric value name field 
							...
							Examples: 
								...
								Scenario: Edit customer with input special value customer ID field 
									...
									Then Verify successfully with message Edit Page "PIN Code must not be blank" 
								...
								Scenario: Edit customer with input special value customer ID field 
									...
									Then Verify successfully with message Edit Page "Mobile no must not be blank" 
								...
								Scenario Outline: Edit customer with input numeric value name field 
									...
									Examples: 
										...
										Scenario: Edit customer with input special value customer ID field 
											...
											Then Verify successfully with message Edit Page "Email-ID must not be blank" 
										...
										Scenario Outline: 
											...
											Examples: 
												...
												Scenario: Edit customer with input special value customer ID field 
													...
													Then Verify successfully with message Edit Page "First character can not have space" 
													Then Close browser
